  ...
  return (
    <SectionWrapper id="hero" className="relative! flex flex-col items-center justify-center">
      ...
      <div className="w-full md:w-3/5 float-end flex flex-col md:flex-row gap-3.5 md:gap-5 items-center-safe">
        <div className="px-5">
          <span className="text-primary-foreground font-inter text-md font-medium border-b border-[#333333] pb-px">
            This Portfolio?*
          </span>
      ...
      <div className="absolute bottom-28 -right-10 md:right-10 -translate-x-1/2 md:translate-x-0 text-right">
        <Link
          href={RESUME_URL}
          target="_blank"
          className="text-sm md:text-md text-primary-foreground text-right font-inter font-semibold text-md border-b border-[#333333] pb-px"
        >
